...
@interface MyFavoriteListViewController ()<JobDataSourceDelegate,UITableViewDelegate,UITableViewDataSource,MJRefreshBaseViewDelegate>{
...
-(void)loadFavoriteList{
    ...
    [[JobDataSource instance] loadFavoriteList:self.appDelegate.loginUser.token page:pageIndex];
}
...
- (void)reloadJobRecord
{
    ...
    if (mainList.count<=0) {
        ...
        headerLabel.text = [NSString stringWithFormat:@"您目前共收藏%ld个职位",mainList.count];
    }
