...
import com.zhoucl.p.suchengzhaopin.ui.MyFavoriteActivity;
...
//    private String salaryUnit;
     ...
     * @Description: TODO
     */
    public FavoriteAdapter(List<Job.Data> data, Context context) {
        ...
        httpUtilsWithToken.send(HttpRequest.HttpMethod.POST,
                ...
                new RequestCallBack<Object>() {
                    ...
                    public void onSuccess(ResponseInfo<Object> responseInfo) {
                        ...
                        HashMap<String, Object> map = ((MyFavoriteActivity) context).parseSimpleJson(responseInfo.result.toString());

                        if ((int) map.get("code") != 1) {
                            ((CheckBox) v).setChecked(!((CheckBox) v).isChecked());
                            if (((MyFavoriteActivity) context).checkLoginState((int) map.get("code"), context)) {
