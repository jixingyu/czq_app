...
import com.zhoucl.p.suchengzhaopin.ui.MainActivity;
...
//    private String salaryUnit;
     ...
     * @Description: TODO
     */
    public JobsAdapter(List<Job.Data> data, Context context) {
...
//        salaryUnit = context.getResources().getString(R.string.salary_unit);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = View.inflate(parent.getContext(), R.layout.item_job, null);
        ...
        httpUtilsWithToken.send(HttpRequest.HttpMethod.POST,
                ...
                new RequestCallBack<Object>() {
                    ...
                    public void onSuccess(ResponseInfo<Object> responseInfo) {
                        ...
                        HashMap<String, Object> map = ((MainActivity) context).parseSimpleJson(responseInfo.result.toString());

                        if ((int) map.get("code") != 1) {
                            ((CheckBox) v).setChecked(!((CheckBox) v).isChecked());
                            if (((MainActivity) context).checkLoginState((int) map.get("code"), context)) {
